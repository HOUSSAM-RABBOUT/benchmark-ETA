...
export const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-green-600 via-green-500 to-teal-600 py-20 px-4">
      <div 
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-white mb-6 animate-in fade-in slide-in-from-top-6 duration-700 delay-100">
          Rapport Comparatif
        </h1>
